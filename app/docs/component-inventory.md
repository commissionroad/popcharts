...
| `OutcomeButton`    | `app/src/components/ui/outcome-button.tsx`    | `designkit/components/OutcomeButton`    | YES/NO price action tile             | `side`, `priceCents`, optional `label` (creator outcome label), `href`, `selected`, `sub`                                                | Market cards                                                                             |
