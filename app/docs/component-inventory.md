...
| `OutcomeButton`    | `app/src/components/ui/outcome-button.tsx`    | `designkit/components/OutcomeButton`    | YES/NO price action tile             | `side`, `priceCents`, optional `href`, `onClick`, `selected`, `sub`; renders a link with `href`, otherwise a real button with `aria-pressed`                                                                                         | Market cards                                                                             |
