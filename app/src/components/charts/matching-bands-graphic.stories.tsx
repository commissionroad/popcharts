...
const meta = {
  ...
  component: MatchingBandsGraphic,
  render: (args) => (
    <main className="min-h-screen bg-[var(--color-page-bg)] p-4 sm:p-8">
      <div className="mx-auto w-full max-w-5xl">
        <MatchingBandsGraphic {...args} />
      </div>
    </main>
  ),
  title: "Charts/Matching Bands Graphic",
} satisfies Meta<typeof MatchingBandsGraphic>;

export default meta;

type Story = StoryObj<typeof meta>;

export const ReceiptBandTimeline: Story = {};
