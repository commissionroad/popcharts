...
const meta = {
  ...
  component: MatchingBandsHeatmap,
  render: (args) => (
    <main className="min-h-screen bg-[var(--color-page-bg)] p-4 sm:p-8">
      <div className="mx-auto w-full max-w-5xl">
        <MatchingBandsHeatmap {...args} />
      </div>
    </main>
  ),
  title: "Charts/Matching Bands Heatmap",
} satisfies Meta<typeof MatchingBandsHeatmap>;

export default meta;

type Story = StoryObj<typeof meta>;

export const ProbabilityHeatmap: Story = {};
