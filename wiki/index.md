...
- [ADR 0021](summaries/root-adr-0021-live-market-updates.md) — Proposed: SSE invalidations over an explicit transactional semantic outbox; subscribe-then-refetch is reconnect correctness, cursor replay is best-effort, and age-based retention is mandatory (PR #249 regressions reopened slice 1)
