...
- [ADR 0020](summaries/root-adr-0020-concurrent-local-dev-stacks.md) — concurrent local dev stacks as slot-addressed instances (slot 0 human, 1..n agents) with a home-dir registry, per-slot chain/DB/env/ports, identity-scoped chain reuse, and stack-aware create-market (Phases 1–3 implemented 2026-07-17; stack-aware scripts remain)
