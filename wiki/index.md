...
- [ADR 0014](summaries/root-adr-0014-full-lifecycle-e2e-testing.md) — the every-terminal-state e2e suite; acceptance gate for M1–M4 (delivery re-homed into ADR 0017 Track C: service/chain layer + five UI journeys; all eight service/chain paths landed 2026-07-20/21 = ADR 0017 C3 complete; the golden UI journey (C4) landed 2026-07-22, four open)
