...
| `POPCHARTS_ADMIN_REVIEW_ENABLED`                                      | Gone. Read by no code, and removed from the local stack's env scripts on 2026-08-06.                                                          |
...
| `POPCHARTS_REVIEW_MANAGER_PRIVATE_KEY`                                | Gone. Read by no code, and removed from `server/sample.env` on 2026-08-06. Draft review holds no chain key.                                   |
