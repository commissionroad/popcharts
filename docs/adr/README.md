...
which extends 0024's runner), 0027 (verdict-quality loop), 0028 (recurring
price markets), and 0029 (market-maker agents) are likewise standalone tracked
programs.
